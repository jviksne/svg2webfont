# svg2cssfont
 ...
 Each file will be considered to represent a single character with the file name (without extension) becoming a CSS class with a custom ("ico-" by default) prefix. Files do not need to be structured.

 Script generates a CSS file and two font files in WOFF and WOFF 2.0 formats. To use the fonts as icons the CSS file needs to be included.
 
 Icon HTML tag format:
